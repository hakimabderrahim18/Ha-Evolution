...
export default function GoalsTracker() {
  ...
  const handleToggleComplete = (id, completed, xp) => {
    if (!completed) {
      // Trigger a big quest-completed burst!
      confetti({
        particleCount: 100,
        spread: 70,
        origin: { y: 0.6 },
    ...
    <GlassCard className="border-primary/10 flex flex-col justify-between p-6 h-[480px] relative group" tilt={false}>
      ...
      <div className="flex flex-col h-full overflow-hidden">
        ...
        <div className="flex justify-between items-center mb-4 shrink-0">
          <div>
            <span className="text-[10px] font-space font-bold text-primary tracking-widest uppercase bg-primary/10 px-3 py-1 rounded-full border border-primary/20 block w-max mb-1.5">
              QUESTS
            </span>
        ...
        {/* Progress row */}
        {totalCount > 0 && (
          <div className="mb-4 bg-[#121A2C]/60 border border-white/5 p-3 rounded-xl shrink-0">
            <div className="flex justify-between items-center text-xs font-space mb-1.5">
        ...
        <div className="flex-1 overflow-y-auto pr-1 custom-scrollbar">
          {showAddForm ? (
            ...
            <div className="flex flex-col items-center justify-center h-full py-12 text-center">
              ...
              <p className="text-white/40 text-xs italic">No weekly goals set.</p>
